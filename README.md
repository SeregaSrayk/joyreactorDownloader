...
- **Фильтры из коробки Joyreactor**: текст, теги (включая исключения —
  блокировка каноничного тега автоматически ловит его alias-варианты
  написания), автор, мин/макс рейтинг, NSFW / unsafe / «только избранное»;
  плюс клиент-сайд: тип медиа (JPEG/PNG/GIF/MP4/WEBM), мин. ширина/высота,
